...
class GitLabTrackedIssue(Base):
    ...
    activity_source: Mapped[str | None] = mapped_column(String(20), nullable=True)
    activity_description_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    activity_comment_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
